                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input align="left" style="width:2%;" type="checkbox" class="form-control" name="author" value=1 {{$user->author == true ? 'checked' : ''}}>Author
                                                </br>
                                                <input align="left" style="width:2%;" type="checkbox" class="form-control" name="admin" value=1 {{ $user->admin == true ? 'checked' : '' }}>Admin
                                            </div>
                                    </div>
                                </div>

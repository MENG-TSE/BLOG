...
class PayPal
{
    public static function apiContext()
    {
        ...
        $clientId = 'AXOvLqWUiZ4rFZ7JO61ZR_Yp9FrsfHEx0R7eQLhhdo9yphPKK3CLqkGKBxdszcdxeJG-CtONkbOhqskg';
        $clientSecret = 'EHIq7kL4Nz52lxd_SjyTIbR7X_GlldzRY5PMVCqtkzaHkBm9_foQKs0mqwmoX_kiX9YQyQ9tLWUpM_tp';
        /**
